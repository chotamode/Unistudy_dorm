        ...
        <div>
            <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
                    <h1 className="text-lg phone:text-xl sm:text-4xl md:text-5xl lg:text-[4.2rem] xl:text-[5rem] font-bold text-black p-4  sm:p-12 md:p-16 rounded-xl text-center">
                        <div className="text-white">Student housing rentals</div>
                        <div className="text-[#A6D0FF]"> — easy and convenient!</div>
                        <p className="text-white mt-2 text-xs sm:text-xs md:text-sm lg:text-lg font-light w-8/12 phone:w-6/12 sm:w-2/3 md:w-1/2 mx-auto">
