                    ...
                    <div className="text-center font-medium">
                        <ul className="flex flex-col text-left font-montserrat gap-y-2 ">
                            ...
                            <li className="text-lg">
                                ...
                                <div><a href="#adress" className="hover:underline">Jaurisova 515/4, Praha 4 - Michle</a>
                                </div>
                            </li>
                            <li className="text-lg"><a href="#https://roomrent.cz/" className="hover:underline">Link to
