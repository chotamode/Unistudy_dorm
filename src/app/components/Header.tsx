...
const Header = () => {
    ...
    return (
        <header
            className={`static top-0 left-0 w-full p-4 ${isGayBlueBackground ? 'bg-blue-100 tablet:bg-transparent' : isBlueBackground ? 'bg-[#0F478D] md:bg-transparent' : 'bg-transparent'} z-20`}>
